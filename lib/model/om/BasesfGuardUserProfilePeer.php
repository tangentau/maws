...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Email' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'email' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::EMAIL => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'email' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
