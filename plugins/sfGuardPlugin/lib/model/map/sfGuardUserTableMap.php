...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('MawsParser', 'MawsParser', RelationMap::ONE_TO_MANY, array('id' => 'owner_id', ), null, null);
    $this->addRelation('MawsThread', 'MawsThread', RelationMap::ONE_TO_MANY, array('id' => 'owner_id', ), null, null);
    $this->addRelation('MawsPage', 'MawsPage', RelationMap::ONE_TO_MANY, array('id' => 'owner_id', ), null, null);
	} // buildRelations()
